...
class ModularFXWindow(NodeEditorWindow):
    ...
    def createActions(self):
        ...
        self.actAbout = QAction("&About", self, statusTip="Show the application's About box",
    ...
    def about(self):
        QMessageBox.about(self, "ModularFX",
                          "A <b>Modular</b> sound synthesizer "
                          "<a href='https://github.com/ali1234/modularfx'>https://github.com/ali1234/modularfx</a>")
    ...
    def createNodesDock(self):
        for k, v in node_groups.items():
            self.nodesListWidget = NodeList(v)
            self.nodesDock = QDockWidget(k)
    ...
    def createMdiChild(self, child_widget=None):
        nodeeditor = child_widget if child_widget is not None else Editor()
